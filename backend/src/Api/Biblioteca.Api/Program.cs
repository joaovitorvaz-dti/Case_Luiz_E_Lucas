...
builder.Services.AddValidatorsFromAssemblyContaining<LivroValidator>(); // Registra todos os validadores da assembly: LivroValidator, UsuarioValidator, EmprestimoValidator, ReservaValidator
